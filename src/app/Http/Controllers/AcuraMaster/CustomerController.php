...
use App\Models\AcuraMaster\Customer;
...
class CustomerController extends Controller
{
    ...
    {
        return view('backend.master-acura.customer')->with('form_input',$this->form_data)
                    ->with('salesman',array_merge($this->head, ['action']));
    }
    public function grid()
    {
        
        $sal = Customer::select($this->head);
    ...
    {
        $sal = Customer::updateOrCreate(['id' => $request->id],[
